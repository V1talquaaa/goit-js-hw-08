...
const markup = (0, _galleryItems.galleryItems).map((item)=>`<li class="gallery__item">
<a class="gallery__link" href=${item.original}>
   <img class="gallery__image" src=${item.preview} alt=${item.description} />
</a>
</li>`).join("");
galleryRef.insertAdjacentHTML("beforeend", markup);
const openImageGallery = new (0, _simplelightboxDefault.default)(".gallery a", {
    captionsData: "alt",
    captionDelay: 250
});
...
},{}],"kaxSc":[function() {},{}]},["9VJAZ","6XVkV"], "6XVkV", "parcelRequired7c6")
